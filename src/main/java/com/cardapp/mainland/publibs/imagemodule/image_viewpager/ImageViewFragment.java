...
public final class ImageViewFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.imagemodule_item_viewpager_image, container, false);
		...
		if (args != null) {
			...
			image.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					Intent picIntent = new Intent(getActivity(), ZoomPictureActivityMIS.class);
					picIntent.putExtra(ZoomPictureActivityMIS.INTENT_PICTURES,
							args.getStringArrayList(ARGS_ALL_IMAGE_URL));
					picIntent.putExtra(ZoomPictureActivityMIS.INTENT_CURRENT_PIC, imageUrl);
