...
public class ZoomPictureTransparentActivity extends CaBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.imagemodule_activity_zoom_picture_transparent);
    ...
    private void findViews() {
        ...
        mToolManager = new ZpTitleBarManager(ZoomPictureTransparentActivity.this, mToolbar);
    }
